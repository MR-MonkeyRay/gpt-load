...
var migrations = []migration{
	...
	{ID: migrationfiles.ID0018, Up: migrationfiles.Up0018, Validate: migrationfiles.Validate0018, ValidateRecoverable: migrationfiles.ValidateRecoverable0018},
	{
		...
		ValidateCurrent:     migrationfiles.ValidateCurrent0019,
		ValidateRecoverable: migrationfiles.ValidateRecoverable0019,
	},
	{
		ID:                  migrationfiles.ID0020,
		Up:                  migrationfiles.Up0020,
		Validate:            migrationfiles.Validate0020,
		ValidateRecoverable: migrationfiles.ValidateRecoverable0020,
	},
	{
		ID:                  migrationfiles.ID0021,
		Up:                  migrationfiles.Up0021,
		Validate:            migrationfiles.Validate0021,
		ValidateRecoverable: migrationfiles.ValidateRecoverable0021,
	},
}
